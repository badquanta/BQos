...
LIBC_BUILD_DIR	:= $(XBUILD_DIR)/libc
...
XGCC_MAKE_TARGET := $(TARGETS)/xgcc-make.tag
XGCC_INSTALL_TARGET := $(TARGETS)/xgcc-install.tag
...
LIBC_H_SRCS			+= $(wildcard $(LIBC_INC_DIR)/*/*.h)
# Generate list of binaries from lists of source code.
