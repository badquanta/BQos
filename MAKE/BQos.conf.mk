...
BQos_CPP_SRCS		:= $(shell find $(BQos_CPP_SRC_DIR) -name "*.cpp")
BQos_CPP_SRCS		+= $(shell find $(BQos_CPP_SRC_DIR) -name "*.cpp")
BQos_CPP_SRCS		+= $(shell find $(BQos_CPP_SRC_DIR) -name "*.cpp")
BQos_CPP_SRCS		+= $(shell find $(BQos_CPP_SRC_DIR) -name "*.cpp")
ALL_SUFFIXES		+= .cpp
BQos_S_SRCS			:= $(shell find $(BQos_S_SRC_DIR) -name "*.s")
BQos_S_SRCS			+= $(shell find $(BQos_S_SRC_DIR) -name "*.s")
BQos_S_SRCS			+= $(shell find $(BQos_S_SRC_DIR) -name "*.s")
BQos_S_SRCS			+= $(shell find $(BQos_S_SRC_DIR) -name "*.s")
ALL_SUFFIXES		+= .s
BQos_HPP_SRCS		:= $(shell find $(BQos_HPP_SRC_DIR) -name "*.hpp")
BQos_HPP_SRCS		+= $(shell find $(BQos_HPP_SRC_DIR) -name "*.hpp")
...
ALL_DEP_FILES		+= $(shell find $(BQos_DST_DIR) -name "*.d")
############################################# .kernel(s)
